...
* [Partle](https://partle.rubenayla.xyz/) - Search engine over the inventory of physical hardware and DIY shops, with shop locations sourced from OpenStreetMap. ([API](https://partle.rubenayla.xyz/api/docs))
